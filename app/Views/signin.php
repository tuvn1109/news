                    ...
                    <form class="form" id="kt_login_singin_form" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0"
                                   type="text" name="username" placeholder="Tài khoản" autocomplete="off"/>
                        </div>
                        <!--end::Form group-->
                        <!--begin::Form group-->
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0"
                                   type="password" name="password" placeholder="Mật khẩu"  autocomplete="off"/>
                        </div>
                        <!--end::Form group-->
                        <!--begin::Action-->
                        <div class="pb-lg-0 pb-5">
                            <button type="submit" id="kt_login_singin_form_submit_button" onclick="dangNhap()"
...
<script>
    function dangNhap() {
        var formData = new FormData($('#kt_login_singin_form')[0]);
        $.ajax({
            type: 'post',
            url: '/Signin/submitsignin',
            data: formData,
            dataType: "json",
            async: false,
            cache: false,
